...
import type { FlowSchemaState } from "./views/agents-panel-flowschema.ts";
...
export class OpenClawApp extends LitElement {
  ...
  @state() agentsPanel: "overview" | "files" | "tools" | "skills" | "channels" | "cron" | "flowschema" =
    "overview";
  @state() flowSchema: FlowSchemaState = {
    loading: false, error: null, flowTypes: [], selectedId: null,
    detail: null, graphData: null, view: "editor",
    saving: false, saveMsg: null, registerResult: null,
  };
