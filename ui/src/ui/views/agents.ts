...
import {
  renderAgentFlowSchema,
  type FlowSchemaState,
  FLOW_SCHEMA_INITIAL,
} from "./agents-panel-flowschema.ts";
export type { FlowSchemaState };
export { FLOW_SCHEMA_INITIAL };
import {
  agentBadgeText,
  buildAgentContext,
  buildModelOptions,
...
export type AgentsPanel = "overview" | "files" | "tools" | "skills" | "channels" | "cron" | "flowschema";
...
export type AgentsProps = {
  ...
  flowSchemaState: FlowSchemaState;
  onFlowSchemaSelectType: (id: string) => void;
  onFlowSchemaSwitchView: (v: "editor" | "graph") => void;
  onFlowSchemaRegister: (id: string) => void;
  onFlowSchemaRefresh: () => void;
};
        ...
        ${
          !selectedAgent
            ...
            : html`
                ...
                ${
                  props.activePanel === "flowschema"
                    ? renderAgentFlowSchema({
                        state: props.flowSchemaState,
                        onSelectFlowType: props.onFlowSchemaSelectType,
                        onSwitchView: props.onFlowSchemaSwitchView,
                        onRegister: props.onFlowSchemaRegister,
                        onRefresh: props.onFlowSchemaRefresh,
                      })
                    : nothing
                }
                ${
...
function renderAgentTabs(active: AgentsPanel, onSelect: (panel: AgentsPanel) => void) {
  const tabs: Array<{ id: AgentsPanel; label: string }> = [
    ...
    { id: "flowschema", label: "Flow Schemas" },
